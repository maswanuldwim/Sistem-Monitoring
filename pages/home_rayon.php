<div id="page-wrapper">
    ...
    <tbody>
     <?php
            $result = mysql_query("SELECT * FROM beranda WHERE vendor='HSI' GROUP BY tgl_pasang, No DESC");
            $no=1;
    ...
    <tbody>
     <?php
            $result = mysql_query("SELECT * FROM beranda WHERE vendor='JAYA' GROUP BY tgl_pasang, No DESC");
            $no=1;
            while($data = mysql_fetch_array($result)){
                ?>
    ...
    <tbody>
     <?php
            $result = mysql_query("SELECT * FROM beranda WHERE vendor='TJAKRINDO' GROUP BY tgl_pasang, No DESC");
            $no=1;
            while($data = mysql_fetch_array($result)){
                ?>
    ...
    <tbody>
     <?php
            $result = mysql_query("SELECT * FROM beranda WHERE vendor='TONGGAK' GROUP BY tgl_pasang, No DESC");
            $no=1;
            while($data = mysql_fetch_array($result)){
                ?>
    ...
    <tbody>
     <?php
            $result = mysql_query("SELECT * FROM beranda WHERE vendor='WIKA' GROUP BY tgl_pasang, No DESC");
            $no=1;
            while($data = mysql_fetch_array($result)){
                ?>

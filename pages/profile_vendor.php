<div id="page-wrapper">
    ...
    <tbody>
     <?php
       ...
       <?php echo"<a class='btn btn-danger btn-sm' href='?pages=profile_vendor&hapus=true&id=$data[no]' onclick='return confirm(\"Apakah Anda yakin ?\")'>  <i class='glyphicon glyphicon-trash icon-white'></i></a>"?>
        </td>
    </tr>
            <?php $no++; } ?>
    </tbody>
...
if($_GET['hapus']=="true"){
    $urutan = $_REQUEST['id'];
    $result = mysql_query("delete from profile_vendor where profile_vendor.`no`='$urutan'");
    if($result){

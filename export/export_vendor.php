...
if(!isset($_SESSION['admin'])) header('Location: login.php');
    $user = $_SESSION['id'];
    $query_user = mysql_query("SELECT * FROM admin WHERE id='$user'") or die(mysql_error());
...
<center><h3>Tiang Beton PT PLN UP3 GRESIK, KAB.GRESIK TAHUN &nbsp;<?php echo $tahun ?></h3></center>
<table border='2'>
<h3>
<thead><tr>
...
<?php
$d = mysql_query("select * from beranda WHERE vendor='$username' ORDER BY tgl_pasang DESC");
$no=1;
